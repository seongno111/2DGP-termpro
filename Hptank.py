...
class Hptank:
    ...
    def __init__(self):
        ...
        if self.image[0] is None:
            self.image[0] = load_image('char/klat01_01.png')
            self.image[1] = load_image('char/klat01_02.png')
            self.image[2] = load_image('char/klat01_03.png')
            self.image[3] = load_image('char/klat01_04.png')
            self.image[4] = load_image('char/klat01_05.png')
            self.image[5] = load_image('char/klat01_06.png')
            self.image[6] = load_image('char/klat01_07.png')
            self.at_image[0] = load_image('char/hp_at_ef_01.png')
            self.at_image[1] = load_image('char/hp_at_ef_02.png')
            self.at_image[2] = load_image('char/hp_at_ef_03.png')

            self.sk_image[0] = load_image('char/klat_skill1.png')
            self.sk_image[1] = load_image('char/klat_skill2.png')
            self.sk_image[2] = load_image('char/klat_skill3.png')
            self.sk_image[3] = load_image('char/klat_skill4.png')
            self.sk_image[4] = load_image('char/klat_skill5.png')
            self.sk_image[5] = load_image('char/klat_skill6.png')
            self.sk_image[6] = load_image('char/klat_skill7.png')
            self.sk_image[7] = load_image('char/klat_skill8.png')
        if self.image_l is None:
            self.image_l = load_image('char/klat_link.png')
        self.IDLE = Idle(self)
