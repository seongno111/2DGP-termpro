...
class Knight:
    ...
    def __init__(self):
        ...
        if self.image[0] is None:
            ...
            self.image[1] = load_image('char/tuar03_02.png')
            self.image[2] = load_image('char/tuar03_03.png')
            self.image[3] = load_image('char/tuar03_04.png')
            self.image[4] = load_image('char/tuar03_05.png')
            self.image[5] = load_image('char/tuar03_06.png')
            self.image[6] = load_image('char/tuar03_07.png')
        if self.image_at[0] is None:
            self.image_at[0] = load_image('char/k_at_ef_01.png')
            self.image_at[1] = load_image('char/k_at_ef_02.png')
            self.image_at[2] = load_image('char/k_at_ef_03.png')
        if self.image_sk[0] is None:
            self.image_sk[0] = load_image('char/tuar_skill01.png')
            self.image_sk[1] = load_image('char/tuar_skill02.png')
            self.image_sk[2] = load_image('char/tuar_skill03.png')
            self.image_sk[3] = load_image('char/tuar_skill04.png')
            self.image_sk[4] = load_image('char/tuar_skill05.png')
            self.image_sk[5] = load_image('char/tuar_skill06.png')
        if self.image_l is None:
            self.image_l = load_image('char/tuar_link.png')
        self.IDLE = Idle(self)
